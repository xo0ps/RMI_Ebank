 ...
 */
public class LongProfitableAccountType implements Serializable {
    private int row;
    ...
    public boolean isHasAtmCard() {
        return hasAtmCard;
    }

    public void setHasAtmCard(boolean hasAtmCard) {
        this.hasAtmCard = hasAtmCard;
    }
    ...
    public boolean equals(Object o) {
        ...
        LongProfitableAccountType that = (LongProfitableAccountType) o;

        if (currentMoney != that.currentMoney) return false;
        if (hasAtmCard != that.hasAtmCard) return false;
    ...
    public int hashCode() {
        ...
        result = 31 * result + (hasAtmCard ? 1 : 0);
